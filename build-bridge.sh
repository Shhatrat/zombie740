#!/bin/bash
# ZOMBIE740-BRIDGE: SSH only, L2 bridge (all ports in one segment)
# Minimal — no routing, no DHCP, managed via SSH at 192.168.1.1
set -e
...
FILES_VARIANT="$SCRIPT_DIR/files-variants/bridge"
OUTPUT_DIR="$SCRIPT_DIR"
VARIANT="bridge"
LOG="$SCRIPT_DIR/build-${VARIANT}.log"

echo "=== ZOMBIE740-BRIDGE build ==="
echo "Log: $LOG"
