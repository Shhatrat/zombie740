...
<li><a href="/cgi-bin/network">Network</a></li>
<li><a href="/cgi-bin/dhcp">DHCP/DNS</a></li>
<li><a href="/cgi-bin/firewall">Firewall</a></li>
<li><a href="/cgi-bin/diag">Diagnostics</a></li>
...
<li><a href="/cgi-bin/network"$([ "$active" = "network" ] && echo ' class="active"')>Network</a></li>
...
<li><a href="/cgi-bin/portfw"$([ "$active" = "portfw" ] && echo ' class="active"')>Port Fwd</a></li>
<li><a href="/cgi-bin/logs"$([ "$active" = "logs" ] && echo ' class="active"')>Logs</a></li>
