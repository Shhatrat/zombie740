#!/bin/bash
# ZOMBIE740-VPN: SSH + DHCP/DNS + firewall4 + WireGuard
# VPN gateway — routes LAN traffic through WireGuard tunnel
# NOTE: edit files-variants/vpn/etc/config/network and set private_key before building
set -e
...
FILES_VARIANT="$SCRIPT_DIR/files-variants/vpn"
OUTPUT_DIR="$SCRIPT_DIR"
VARIANT="vpn"
LOG="$SCRIPT_DIR/build-${VARIANT}.log"

echo "=== ZOMBIE740-VPN build ==="
echo "Log: $LOG"
