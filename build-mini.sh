#!/bin/bash
# ZOMBIE740-MINI: SSH + DHCP/DNS, no firewall
# Second router behind main router, lab/dev use
set -e
...
FILES_VARIANT="$SCRIPT_DIR/files-variants/mini"
OUTPUT_DIR="$SCRIPT_DIR"
VARIANT="mini"
LOG="$SCRIPT_DIR/build-${VARIANT}.log"

echo "=== ZOMBIE740-MINI build ==="
echo "Log: $LOG"
