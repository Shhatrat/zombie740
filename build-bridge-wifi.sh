#!/bin/bash
# ZOMBIE740-BRIDGE-WIFI: SSH only, L2 bridge + WiFi AP (SSID: ZOMBIE740, WPA2: zombie740)
# Based on BRIDGE but adds kmod-ath9k + wpad-basic-mbedtls
set -e
...
FILES_VARIANT="$SCRIPT_DIR/files-variants/bridge-wifi"
OUTPUT_DIR="$SCRIPT_DIR"
VARIANT="bridge-wifi"
LOG="$SCRIPT_DIR/build-${VARIANT}.log"

echo "=== ZOMBIE740-BRIDGE-WIFI build ==="
echo "Log: $LOG"
